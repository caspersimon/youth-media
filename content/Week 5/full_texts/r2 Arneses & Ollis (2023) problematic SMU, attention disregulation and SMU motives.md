...
Social media helps to form and maintain social connec­tions, and to create supportive communities for individu­als from diverse groups, including LGBT + adolescents, individuals from ethnic minorities and those with chronic illnesses (Shapiro & Margolin, 2014; Van Den Eijnden et 
...
al., 2018). A qualitative study by Radovic and colleagues (2017), which explored the positive and negative uses of social media in adolescents with depression, reported that some depressed teens use social media to seek encour­agement and inspiration or for self-refection via a private online journal. Further benefts of social media use include increased perceived social support and decreased loneliness (Best et al., 2014; Lee et al., 2013). However, despite many benefts of social media, popular narrative often focuses on the negative outcomes for users, which is refected in the research literature (Owenz, n.d.).
